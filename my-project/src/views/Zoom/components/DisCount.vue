<template>
  <div class="page"> 
     <div class="head">
        <a href="javascript:;">你有0张优惠券</a>
        <a href="javascript:;">添加优惠券</a>
     </div>
     <div class="center">
        <h3>微博电影代金券</h3>
        <p>微博电影购票可用票价满30元可用</p>
        <p>有效期至:2017-02-09</p>
        <div class="price">
          <div class="price_num">
          </div>
